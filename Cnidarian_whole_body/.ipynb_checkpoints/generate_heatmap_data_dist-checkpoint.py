...
def plot_one2one_class_heatmap(species_name_dict, out_dir):
    ...
    for pair in all_pairs:
        ...
        # already give O2O data in the function
        heatmap_data, o2o_heatmap = plot_cross_species_dist_category_heatmap(mapping_all.loc[mapping_all.orthology_type == 'one2one', :], species_1, species_2)
        
        o2o_heatmap.write_image(f"{out_dir}/o2o_heatmap_figs_dist/{species_1}_{species_2}_1e6_0.1lim_3fold_broad_type_o2o_heatmap_dist.pdf")
        
        heatmap_data.to_csv(f"{out_dir}/o2o_heatmap_data_{species_1}_{species_2}_1e6_0.1lim_3fold_broad_type_dist.csv")
...
if __name__ == "__main__":
    ...
    plot_one2one_class_heatmap(species_name_dict=species_name_dict, out_dir='/nfs/research/irene/ysong/DATA/Cnidarians/ortholg_conjecture_analysis/o2o_heatmap/')
